...
def build_sam_vit_h_old(image_size, num_classes, pixel_mean=[123.675, 116.28, 103.53], pixel_std=[58.395, 57.12, 57.375],
                    checkpoint=None):
    return _build_sam_old(
        encoder_embed_dim=1280,
        encoder_depth=32,
        encoder_num_heads=16,
        encoder_global_attn_indexes=[7, 15, 23, 31],
...
def build_sam_vit_h_new(image_size, num_classes, pixel_mean=[123.675, 116.28, 103.53], pixel_std=[58.395, 57.12, 57.375],
                    checkpoint=None):
    return _build_sam_new(
        encoder_embed_dim=1280,
        encoder_depth=32,
        encoder_num_heads=16,
        encoder_global_attn_indexes=[7, 15, 23, 31],
...
def build_sam_vit_b_old(image_size, num_classes, pixel_mean=[123.675, 116.28, 103.53], pixel_std=[58.395, 57.12, 57.375],
                    checkpoint=None):
    return _build_sam_old(
        encoder_embed_dim=768,
        encoder_depth=12,
...
def build_sam_vit_b_new(image_size, num_classes, pixel_mean=[123.675, 116.28, 103.53], pixel_std=[58.395, 57.12, 57.375],
                    checkpoint=None):
    return _build_sam_new(
        encoder_embed_dim=768,
        encoder_depth=12,
...
sam_model_registry = {
    ...
    "build_sam_vit_h_old": build_sam_vit_h_old,
    "build_sam_vit_b_old": build_sam_vit_b_old,
    "build_sam_vit_b_new": build_sam_vit_b_new,
    "build_sam_vit_h_new": build_sam_vit_h_new
}
...
def _build_sam_old(
    ...
    sam = Sam_OLD(
        ...
        mask_decoder = MaskDecoder_origin(
